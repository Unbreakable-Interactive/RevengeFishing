...
public class GameStates : MonoBehaviour
{
    ...
    public bool IsUpgrade() => currentGameState == GameState.Upgrade;
    public void TogglePause()
    {
        if (IsGameplayRunning()) SetGameState_Pause();
        else if (IsGamePaused()) GoBackToOldGameState();
    }
    ...
    public void GoBackToOldGameState()
    {
        GameLogger.Log($"[Game States] - {previousGameState.ToString()}");
