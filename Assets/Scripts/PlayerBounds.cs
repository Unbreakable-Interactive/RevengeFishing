...
//            if (playerPos.x < bounds.min.x) bounceDirection.x = 1;      // Left wall
//            if (playerPos.x > bounds.max.x) bounceDirection.x = -1;     // Right wall  
//            if (playerPos.y < bounds.min.y) bounceDirection.y = 1;      // Bottom wall

//            // Apply bounce
//            if (bounceDirection != Vector2.zero)
//            {
//                playerRb.velocity = Vector2.Reflect(playerRb.velocity, bounceDirection) * bounceForce;
//            }
//        }
//    }
//}
